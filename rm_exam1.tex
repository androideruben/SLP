...
\begin{enumerate}	
	\item SPEED como Y y DENSITY como X
	\item Ra\'iz cuadrada de SPEED como Y y DENSITY como X
	\item SPEED como Y y ra\'iz cuadrada de DENSITY como X
\end{enumerate}	
	
	
Haz lo siguiente para cada una de las tres regresiones:

\begin{itemize}
\item \textbf{\textit{Reporta por escrito en papel}} cada uno de los modelos estimados (donde pones los 
n\'umeros de las pendientes obtenidas por tu programa R y la $\hat{Y}$)

\item\textbf{\textit{Reporta por escrito en papel}} cada uno de los modelos te\'oricos (los modelos con 
$\beta$ y $\varepsilon$)

\item \textbf{\textit{Reporta por escrito en papel}} las hip\'otesis nula $H_{0}$ y alternativa $H_{A}$ de 
la intercept y slope y tu decisi\'on de aceptar o no las hip\'otesis nula con un nivel de significancia de $\alpha$= 0.05 (usa los p-value)

\item \textbf{\textit{Reporta por escrito en papel}} las hip\'otesis nula $H_{0}$ y alternativa $H_{A}$ del 
\textit{Full Model} (el del estadist\'ico F) 
y tu decisi\'on de aceptar o no la hip\'otesis nula con un nivel de significancia de $\alpha$= 0.05 (usa 
el p-value asociado a dicha F)



\end{itemize}

\item La hip\'otesis nula $H_{0}$ y alternativa $H_{A}$ del modelo (el que 
\end{itemize}
