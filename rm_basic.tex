...
A diferencia de nuestro modelo de regresion en donde X es medida sin error y Y es medida con error, en las pruebas de independencia 
tanto Y como X son variables con errores.
(Hay modelos lineales donde la X puede ser medida con error, uno de estos modelos es el Linear Mixed Model
que sera tema de un curso posterior).
